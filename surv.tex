...
%Reasons and means for modeling preferences as incomplete.
	...
	\begin{itemize}
		\item In De Finetti setting, it is assumed that utilities are given as random variables, and that a precise price can be associated to each random variable. That reasoning should follow probabilistic calculus and choices expected utility then follow from two rationality axioms: linearity and boundedness of those prices.
