...
\begin{document}
	...
	* MCDM model that induce incomplete orders (CP-net... others?)
	...
	\subsubsection{Keeping expected utility but not precise probabilities}
