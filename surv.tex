...
\begin{document}
	...
	\commentOC{En fait, c’est ce que j’essayais d’expliquer dans un e-mail précédent. Je voulais tenter de rendre compatible le modèle vNM et l’approche où les utilités sont données.}
	...
	\commentOC{Ici on pourrait parler des autres approches à la Savage etc., mais qui postulent la complétude.}
