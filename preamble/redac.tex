...
%\newcommand{\commentSD}[1]{{\small\color{red}{\selectlanguage{french}$\big[$SD: #1$\big]$}}}
%\newcommand{\commentOC}[1]{{\small\selectlanguage{french}\todo[color=blue!40]{OC: #1}}}
\newcommand{\commentOC}[1]{}
\newcommand{\commentSD}[1]{{\small\selectlanguage{french}\todo[color=green!40]{SD: #1}}}
